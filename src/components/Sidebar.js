...
const Sidebar = () => {
  ...
  return (
    <div className="container">
      <button className={`button ${click ? 'active' : ''}`} onClick={handleClick}>
        {click ? (
      ...
      <div className="sidebar-container">
        ...
        <ul className={`slick-bar`} style={{ width: click ? "12rem" : "3.5rem" }}>
          <li className="item">
            <a href="/admin" onClick={() => setClick(false)}>
              ...
              <span className={`textbar ${click ? 'active' : 'hide'}`}>
                Home
              </span>
            </a>
          </li>
          <li className="item">
            <a href="/admin/add" onClick={() => setClick(false)}>
